...
export const books: Book[] = [
  ...
  },
  {
    ...
    author: "Yazan Lubbad",
    description:
      "An easy-to-follow guide that introduces core principles of software engineering, project planning, and real-world applications.",
    price: 59.99,
    ...
    pages: 420,
    language: "English",
    publisher: "OpenAI Academic Press",
    rating: 4.6,
    reviewCount: 12,
    inStock: true,
    featured: false,
